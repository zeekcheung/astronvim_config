...
return {
  ...
  g = {
    ...
    indent_blankline_highlight_scope = false, -- disable indent blankline hightlight
    noice_enabled = false, -- enable noice.nvim
    dadbod_enabled = false, -- disable vim-dadbod(-ui)
    -- loaded_netrw = 1,
